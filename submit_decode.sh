...
python -u run_decode.py \
  --model_dir /lustre/uc3m/gts_c3_cluster_1-12/zualikha/diffusion_models/diffuseq_qqp_h128_lr0.0001_t2000_sqrt_lossaware_seed102_test-qqp-MSEtarget_restart20260608-14:31:07 \
  --pattern ema_0.9999_025000 \
  --seed 123 \
  --split test 
